        ...
        <>
            ...
            <main ref={containerRef} className="min-h-screen bg-brand-dark pb-28 text-white md:pb-0">
                        ...
                        <div className="detail-info lg:pl-4">
                            ...
                            <div className="detail-feature mt-8 flex flex-col gap-4 sm:flex-row">
                                <button
                                    ...
                                    className="flex-1 rounded-full bg-white px-8 py-4 font-semibold text-brand-dark transition-colors hover:bg-white/90 disabled:cursor-not-allowed disabled:opacity-60"
                ...
                <section className="mx-auto max-w-7xl px-6 pb-20 md:px-12 lg:px-20">
                    <div className="rounded-4xl border border-white/10 bg-brand-dark/60 p-8 md:p-10">
            ...
            <div className="fixed inset-x-0 bottom-0 z-90 border-t border-white/12 bg-brand-dark/95 px-4 pb-[calc(0.75rem+env(safe-area-inset-bottom))] pt-3 backdrop-blur-md md:hidden">
                <div className="mx-auto flex max-w-7xl items-center gap-3">
                    ...
                    <button
                        type="button"
                        onClick={handleAddToCart}
                        className="rounded-full bg-white px-5 py-3 text-sm font-semibold text-brand-dark transition-colors hover:bg-white/90 disabled:cursor-not-allowed disabled:opacity-60"
                        disabled={addedToCart}
                    >
