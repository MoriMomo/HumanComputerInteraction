        ...
        <>
            ...
            <main ref={containerRef} className="min-h-screen bg-brand-dark text-white">
                ...
                <section className="mx-auto max-w-5xl px-6 py-14 md:px-12">
                    ...
                    <div className="post-body mt-14 rounded-4xl border border-white/10 bg-brand-dark/58 p-8 md:p-10">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            {related.map((p) => (
                                <LoadingLink key={p.slug} href={`/blog/${p.slug}`}>
                                    <article className="group overflow-hidden rounded-4xl border border-white/10 bg-brand-dark/64 p-8 transition-all duration-400 hover:-translate-y-1 hover:border-brand-primary/25 hover:shadow-brand-hover">
