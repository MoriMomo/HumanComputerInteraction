                    ...
                    <div className="mt-10 grid grid-cols-1 gap-6 md:grid-cols-2">
                        {posts.map((post) => (
                            <LoadingLink key={post.slug} href={`/blog/${post.slug}`}>
                                <article className="h-full rounded-4xl border border-white/10 bg-brand-dark/64 p-8 transition-all duration-300 hover:-translate-y-1 hover:border-white/22">
