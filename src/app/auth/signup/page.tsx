        ...
        <>
            ...
            <div className="min-h-screen bg-[#0a0f16] text-white flex items-center justify-center px-6 py-32">
                <div className="w-full max-w-md">
                    ...
                    <p className="text-white/50 mb-10">Join the SatSet community</p>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div>
                            <label htmlFor="signup-name" className="block text-xs uppercase tracking-widest text-white/50 mb-2">
                                Name
                            </label>
                            <input
                                id="signup-name"
                        ...
                        <div>
                            <label htmlFor="signup-email" className="block text-xs uppercase tracking-widest text-white/50 mb-2">
                                Email
                            </label>
                            <input
                                id="signup-email"
                        ...
                        <div>
                            <label htmlFor="signup-password" className="block text-xs uppercase tracking-widest text-white/50 mb-2">
                                Password
                            </label>
                    ...
                    <p className="text-center text-white/40 text-sm mt-8">
                        ...
                        <Link href="/auth/login" className="text-white/75 hover:text-white transition-colors underline underline-offset-4">
                            Sign in
                        </Link>
                    </p>
                </div>
